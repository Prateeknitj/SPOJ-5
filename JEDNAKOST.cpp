...
Task - JEDNAKOST from SPOJ 
Algo - DP
Problem - given a string , find min no. of "+" sign to be added in string so that the sum of the pairs of numbers 
          in string become equal to a target sum.
